 ...
 *
 * @ORM\Table(name="ctl_proyecto_municipio", indexes={@ORM\Index(name="idx_b99f01683f09ee2c", columns={"id_proyecto"}), @ORM\Index(name="idx_b99f01687ead49c7", columns={"id_municipio"})})
 * @ORM\Entity
 */
