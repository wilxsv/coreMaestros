...
use Minsal\SuministroBundle\Entity\CtlPresentacion;
...
class CtlPresentacionController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $ctlPresentacions = $em->getRepository('MinsalSuministroBundle:CtlPresentacion')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('Minsal\SuministroBundle\Form\CtlPresentacionType', $ctlPresentacion);
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('presentaciones_show', array('id' => $ctlPresentacion->getId()));
        }
    ...
    {
        $deleteForm = $this->createDeleteForm($ctlPresentacion);
        $editForm = $this->createForm('Minsal\SuministroBundle\Form\CtlPresentacionType', $ctlPresentacion);
        $editForm->handleRequest($request);

        if ($editForm->isSubmitted() && $editForm->isValid()) {
            $this->getDoctrine()->getManager()->flush();

            return $this->redirectToRoute('presentaciones_edit', array('id' => $ctlPresentacion->getId()));
        }
    ...
    public function deleteAction(Request $request, CtlPresentacion $ctlPresentacion)
    {
        ...
        return $this->redirectToRoute('presentaciones_index');
    }
    ...
    private function createDeleteForm(CtlPresentacion $ctlPresentacion)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('presentaciones_delete', array('id' => $ctlPresentacion->getId())))
            ->setMethod('DELETE')
            ->getForm()
        ;
    }
