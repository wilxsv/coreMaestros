...
use Maestro\ModeloBundle\Entity\CtlRol;
...
class CtlRolController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $ctlRols = $em->getRepository('MaestroModeloBundle:CtlRol')->findAll();
    ...
    {
        $ctlRol = new Ctlrol();
        $form = $this->createForm('Maestro\ModeloBundle\Form\CtlRolType', $ctlRol);
    ...
    {
        $deleteForm = $this->createDeleteForm($ctlRol);
        $editForm = $this->createForm('Maestro\ModeloBundle\Form\CtlRolType', $ctlRol);
    ...
    public function deleteAction(Request $request, CtlRol $ctlRol)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $em->remove($ctlRol);
            $em->flush($ctlRol);
            $request->getSession()->getFlashBag()->add('error', 'Rol eliminado');
        }
