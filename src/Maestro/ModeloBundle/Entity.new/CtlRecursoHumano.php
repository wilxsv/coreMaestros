...
class CtlRecursoHumano
{
     ...
     * Add equipo
     *
     * @param \Maestro\ModeloBundle\Entity\CtlEquipo $equipo
     * @return CtlRecursoHumano
     */
    public function addEquipo(\Maestro\ModeloBundle\Entity\CtlEquipo $equipo)
    {
        $this->equipo[] = $equipo;
     ...
     * @param \Maestro\ModeloBundle\Entity\CtlEquipo $equipo
     */
    public function removeEquipo(\Maestro\ModeloBundle\Entity\CtlEquipo $equipo)
    {
