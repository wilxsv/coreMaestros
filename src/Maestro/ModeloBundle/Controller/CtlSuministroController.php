...
use Maestro\ModeloBundle\Entity\CtlSuministro;
...
class CtlSuministroController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $ctlSuministros = $em->getRepository('MaestroModeloBundle:CtlSuministro')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('Maestro\ModeloBundle\Form\CtlSuministroType', $ctlSuministro);
    ...
    {
        $deleteForm = $this->createDeleteForm($ctlSuministro);
        $editForm = $this->createForm('Maestro\ModeloBundle\Form\CtlSuministroType', $ctlSuministro);
    ...
    private function createDeleteForm(CtlSuministro $ctlSuministro)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('suministro_delete', array('id' => $ctlSuministro->getId())))
            ->setMethod('DELETE')
            ->getForm()
        ;
    }
