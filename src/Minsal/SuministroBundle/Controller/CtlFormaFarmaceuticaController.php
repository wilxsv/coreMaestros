...
use Minsal\SuministroBundle\Entity\CtlFormaFarmaceutica;
...
class CtlFormaFarmaceuticaController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $ctlFormaFarmaceuticas = $em->getRepository('MinsalSuministroBundle:CtlFormaFarmaceutica')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('Minsal\SuministroBundle\Form\CtlFormaFarmaceuticaType', $ctlFormaFarmaceutica);
    ...
    {
        $deleteForm = $this->createDeleteForm($ctlFormaFarmaceutica);
        $editForm = $this->createForm('Minsal\SuministroBundle\Form\CtlFormaFarmaceuticaType', $ctlFormaFarmaceutica);
