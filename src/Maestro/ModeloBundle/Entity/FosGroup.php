...
class FosGroup
{
     ...
     * Add user
     *
     * @param \Maestro\ModeloBundle\Entity\FosUser $user
     * @return FosGroup
     */
    public function addUser(\Maestro\ModeloBundle\Entity\FosUser $user)
    {
        $this->user[] = $user;
     ...
     * @param \Maestro\ModeloBundle\Entity\FosUser $user
     */
    public function removeUser(\Maestro\ModeloBundle\Entity\FosUser $user)
    {
