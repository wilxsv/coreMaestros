...
class CtlCanton
{
     ...
     * @var string
     *
     * @ORM\Column(name="digestyc2015", type="string", length=2, nullable=true)
     */
    private $digestyc2015;
     ...
     * Set digestyc2015
     *
     * @param string $digestyc2015
     * @return CtlCanton
     */
    public function setDigestyc2015($digestyc2015)
    {
        $this->digestyc2015 = $digestyc2015;
     ...
     * @return string 
     */
    public function getDigestyc2015()
    {
        return $this->digestyc2015;
    }
