...
class CtlEstablecimientoType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        ->add('enableSchema', 'choice', array('label'  => 'Opciones a tomar :', 'choices'=> array('0' => 'Seleccionar opcion','-1' => 'Denegar establecimiento', '1' => 'Habilitar establecimiento'), 'required'  => false, ))
