...
use Minsal\SuministroBundle\Entity\CtlCodificacion;
...
class CtlCodificacionController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $ctlCodificacions = $em->getRepository('MinsalSuministroBundle:CtlCodificacion')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('Minsal\SuministroBundle\Form\CtlCodificacionType', $ctlCodificacion);
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('codificaciones_show', array('id' => $ctlCodificacion->getId()));
        }
    ...
    {
        $deleteForm = $this->createDeleteForm($ctlCodificacion);
        $editForm = $this->createForm('Minsal\SuministroBundle\Form\CtlCodificacionType', $ctlCodificacion);
        $editForm->handleRequest($request);

        if ($editForm->isSubmitted() && $editForm->isValid()) {
            $this->getDoctrine()->getManager()->flush();

            return $this->redirectToRoute('codificaciones_edit', array('id' => $ctlCodificacion->getId()));
        }
    ...
    public function deleteAction(Request $request, CtlCodificacion $ctlCodificacion)
    {
        ...
        return $this->redirectToRoute('codificaciones_index');
    }
    ...
    private function createDeleteForm(CtlCodificacion $ctlCodificacion)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('codificaciones_delete', array('id' => $ctlCodificacion->getId())))
            ->setMethod('DELETE')
            ->getForm()
        ;
    }
