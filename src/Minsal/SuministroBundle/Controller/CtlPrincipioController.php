...
use Minsal\SuministroBundle\Entity\CtlPrincipio;
...
class CtlPrincipioController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $ctlPrincipios = $em->getRepository('MinsalSuministroBundle:CtlPrincipio')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('Minsal\SuministroBundle\Form\CtlPrincipioType', $ctlPrincipio);
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('principiosactivos_show', array('id' => $ctlPrincipio->getId()));
        }
    ...
    {
        $deleteForm = $this->createDeleteForm($ctlPrincipio);
        $editForm = $this->createForm('Minsal\SuministroBundle\Form\CtlPrincipioType', $ctlPrincipio);
        $editForm->handleRequest($request);

        if ($editForm->isSubmitted() && $editForm->isValid()) {
            $this->getDoctrine()->getManager()->flush();

            return $this->redirectToRoute('principiosactivos_edit', array('id' => $ctlPrincipio->getId()));
        }
    ...
    public function deleteAction(Request $request, CtlPrincipio $ctlPrincipio)
    {
        ...
        return $this->redirectToRoute('principiosactivos_index');
    }
    ...
    private function createDeleteForm(CtlPrincipio $ctlPrincipio)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('principiosactivos_delete', array('id' => $ctlPrincipio->getId())))
            ->setMethod('DELETE')
            ->getForm()
        ;
    }
